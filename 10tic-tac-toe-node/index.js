...
function horizontalWin() {
  ...
  return winningCombosH.some(combo => {
    return (
...
function verticalWin() {
  ...
  return winningCombosV.some(combo => {
    return (
  ...
  function diagonalWin() {
    let winningCombosD = [[[0, 0], [1, 1], [2, 2]], [[0, 2], [1, 1], [2, 0]]];

    return winningCombosD.some(combo => {
      return (
        board[combo[0][0]][board[combo[1][1]]][board[combo[2][2]]] ===
          playerTurn &&
        board[combo[0][2]][board[combo[1][1]]][board[combo[2][0]]] ===
          playerTurn
      );
    });
    return diagonalWin;
  ...
  function checkForWin() {
    if (horizontalWin || verticalWin || diagonalWin === playerTurn) {
      return true;
    }
  }
